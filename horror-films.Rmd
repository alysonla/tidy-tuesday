...
scale_fill_gradientn(colours = c("#FDF156","#FFC722","#FF9711","#04001B")) + theme_change +
  labs(title="780 horror movies released in the last year", fill="less", caption = "source: IMdB | viz: @alysonla | #tidytuesday") 
# + scale_x_date(date_breaks = "Month", date_labels = "%M", position = "top")

hm

ggsave("horror_movies.png", plot = hm, width = 8, height = 3, dpi = 300)
